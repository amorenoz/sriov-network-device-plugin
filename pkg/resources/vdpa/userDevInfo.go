...
// NewUserInfoProvider creates a UserInfoProvider that implements the DeviceInfoProvider interface
func NewUserInfoProvider(vdpaType string) types.DeviceInfoProvider {
